...
_$_AddressDetails _$_$_AddressDetailsFromJson(Map<String, dynamic> json) {
  return _$_AddressDetails(
    ...
    boundingbox:
        (json['boundingbox'] as List)?.map((e) => e as String)?.toList(),
  );
}

Map<String, dynamic> _$_$_AddressDetailsToJson(_$_AddressDetails instance) =>
    <String, dynamic>{
...
_$_Namedetails _$_$_NamedetailsFromJson(Map<String, dynamic> json) {
  return _$_Namedetails(
    name: json['name'] as String,
  );
}

Map<String, dynamic> _$_$_NamedetailsToJson(_$_Namedetails instance) =>
    <String, dynamic>{
      'name': instance.name,
    };
